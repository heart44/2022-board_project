...
-- 테이블 데이터 board_login.cnt_db:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `cnt_db` DISABLE KEYS */;
REPLACE INTO `cnt_db` (`cnt`, `redate`) VALUES
	(119, '2022-05-04'),
	(35, '2022-05-09'),
	(105, '2022-05-10'),
	(13, '2022-05-11'),
...
REPLACE INTO `t_board` (`i_board`, `title`, `ctnt`, `i_user`, `created_at`, `updated_at`, `filename`, `view_cnt`) VALUES
	...
	(116, '안녕하세요', '안녕히가세요', 1, '2022-05-02 10:54:28', '2022-05-02 10:54:28', '', 1),
	...
	(134, '프로필 사진 확인용', '확인용입니다.', 4, '2022-05-10 12:09:48', '2022-05-10 12:09:48', '', 62),
	...
	(138, 'ㅇㅇ', 'kldsfjljdsklfjds<br />\r\nfkdsjflk<br />\r\n<br />\r\ndskfjsdklfjsdlkf<br />\r\n<br />\r\n<br />\r\ndsfkjsdlfjsdlkf<br />\r\n<br />\r\n<br />\r\n<br />\r\n<br />\r\nsdfjksdjflskdfjklsdjfklsdjfkl', 1, '2022-05-12 14:21:07', '2022-05-12 14:21:07', '', 5),
	(139, 'ㅇㄹㅇㄹㅇ', '지난 2년의 시간 동안 우리는 눈에 보이지 않는 바이러스가 주는 공포로 인해 생존의 위협을 느끼며 일상이 흔들리는 상황을 직면하였다. 이런 환경 속에서 많은 질문을 하게 된다. “우리는 다시 이전의 삶으로 돌아갈 수 있을까? 우리는 앞으로 어떤 삶을 마주하게 될까?”와 같은 것들이다. 코로나19로 우리의 일상에도 급격한 변화가 있었다. 그중 불가피한 사회적 거리 두기는 개개인의 사회 활동을 줄어들게 만들었고 고립감을 야기하기도 했지만, 반면 타인과의 관계에서 돌보지 못했던 자신의 내면을 들여다보고, 타인을 또 다른 거리에서 관찰할 수 있는 시간을 갖게 하였다.<br />\r\n 《나를 만나는 계절》은 유한한 생명의 자연인이지만, 반면에 무한한 생각을 펼치기도 하는 인간에 대한 고찰을 담은 전시이다. 전시는 4개의 주제, ‘생명을 지니다’, ‘일상을 관찰하다’, ‘나를 바라보다’, ‘세상에게 묻다’로 구성된다. 전시의 전개를 생명에서 출발하여 나와 타인, 더 나아가 관계로 이어지는 인간의 삶을 봄, 여름, 가을, 겨울의 사계절에 비유하여 살펴보고자 한다. 생명의 시작을 알리는 봄, 활기찬 일상을 향유하는 여름, 사유의 시간을 갖게 하는 가을과 긴 밤의 침잠에 들게 하는 겨울과 같이 자연의 순환인 계절의 흐름처럼 한 번쯤은 고민해봤을 나와 우리의 삶에 대해 생각해보는 시간을 가지고자 한다. <br />\r\n', 1, '2022-05-12 14:21:31', '2022-05-12 14:21:31', '', 11),
	(140, '겁나 긴 글', '지난 2년의 시간 동안 우리는 눈에 보이지 않는 바이러스가 주는 공포로 인해 생존의 위협을 느끼며 일상이 흔들리는 상황을 직면하였다. 이런 환경 속에서 많은 질문을 하게 된다. “우리는 다시 이전의 삶으로 돌아갈 수 있을까? 우리는 앞으로 어떤 삶을 마주하게 될까?”와 같은 것들이다. 코로나19로 우리의 일상에도 급격한 변화가 있었다. 그중 불가피한 사회적 거리 두기는 개개인의 사회 활동을 줄어들게 만들었고 고립감을 야기하기도 했지만, 반면 타인과의 관계에서 돌보지 못했던 자신의 내면을 들여다보고, 타인을 또 다른 거리에서 관찰할 수 있는 시간을 갖게 하였다.<br />\r\n<br />\r\n 《나를 만나는 계절》은 유한한 생명의 자연인이지만, 반면에 무한한 생각을 펼치기도 하는 인간에 대한 고찰을 담은 전시이다. 전시는 4개의 주제, ‘생명을 지니다’, ‘일상을 관찰하다’, ‘나를 바라보다’, ‘세상에게 묻다’로 구성된다. 전시의 전개를 생명에서 출발하여 나와 타인, 더 나아가 관계로 이어지는 인간의 삶을 봄, 여름, 가을, 겨울의 사계절에 비유하여 살펴보고자 한다. 생명의 시작을 알리는 봄, 활기찬 일상을 향유하는 여름, 사유의 시간을 갖게 하는 가을과 긴 밤의 침잠에 들게 하는 겨울과 같이 자연의 순환인 계절의 흐름처럼 한 번쯤은 고민해봤을 나와 우리의 삶에 대해 생각해보는 시간을 가지고자 한다. <br />\r\n<br />\r\n  이 전시는 대구미술관이 소장하고 있는 1,840점의 작품 중 93점을 선별하여 주제에 맞게 엮었다. 이러한 소장품 기획전을 통해 축적되고 있는 소장품이 단지 수장고에서 보관되고 잠자고 있는 것이 아니라 지속적인 연구와 새로운 해석을 통하여 끊임없이 현재가 되고 새로운 생명을 불어놓고자 한다. 이번 소장품 기획전 《나를 만나는 계절》또한 다양한 삶의 이야기를 공유한 매개체로 소장품의 깊은 면모를 대중에게 선보일 예정이다. <br />\r\n', 1, '2022-05-12 14:22:42', '2022-06-23 10:49:50', '', 20),
	(141, '다시다시수정', '안녕하세요<br />\r\n<br />\r\n<br />\r\n안녕히가세요....<br />\r\n아러ㅏ어라<br />\r\n<br />\r\nㅏㅇ러ㅏㅇ러ㅏ러ㅏㅓㅏ\r\n<br />\r\n하이', 3, '2022-05-13 15:10:15', '2022-05-13 15:10:15', '', 18),
	(144, 'dfsf', 'sgesgsefsefse', 12, '2022-07-08 10:01:44', '2022-07-08 10:01:44', 'KakaoTalk_20220705_165549927.jpg', 5),
	(145, 'sfe', 'sfeefe', 1, '2022-07-11 17:51:53', '2022-07-11 17:51:53', 'KakaoTalk_20220705_165512294.jpg', 2);
...
-- 테이블 데이터 board_login.t_reply:~4 rows (대략적) 내보내기
/*!40000 ALTER TABLE `t_reply` DISABLE KEYS */;
REPLACE INTO `t_reply` (`i_re`, `i_board`, `i_user`, `ctnt`, `created_at`, `updated_at`, `rv`) VALUES
...
REPLACE INTO `t_user` (`i_user`, `uid`, `upw`, `nm`, `gender`, `created_at`, `updated_at`, `profile_img`) VALUES
	(1, 'test1', '$2y$10$xRWey6Ily8F/hV0FpskL9e.SE6e.XSPEInEMe/F5GJEpyfBqXRHq6', '김가나', 0, '2022-04-22 17:46:09', '2022-04-22 17:46:09', '00491595-27de-4899-be13-ae84a24d9876.png'),
	(2, 'test2', '$2y$10$xRWey6Ily8F/hV0FpskL9e.SE6e.XSPEInEMe/F5GJEpyfBqXRHq6', '홍길동', 1, '2022-04-22 17:47:09', '2022-04-22 17:47:09', NULL),
	(3, 'test3', '$2y$10$xRWey6Ily8F/hV0FpskL9e.SE6e.XSPEInEMe/F5GJEpyfBqXRHq6', '이라마', 1, '2022-04-27 09:46:45', '2022-04-27 09:46:45', NULL),
	...
	(11, 'test6', '$2y$10$xRWey6Ily8F/hV0FpskL9e.SE6e.XSPEInEMe/F5GJEpyfBqXRHq6', '최바하', 0, '2022-06-22 14:49:13', '2022-06-22 14:49:13', NULL),
	(12, 'test10', '1234', '아아', 0, '2022-07-08 10:00:53', '2022-07-08 10:00:53', NULL),
